...
namespace MakeCurriculum.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind(Prefix = "Language")] Language obj)
        {
            if (id != obj.Id)
            {
                return NotFound();
        ...
        /* public async Task<JsonResult> LanguageExist([Bind(Prefix = "Language.Name")] string Name)
        {
            if (await _languageService.NameExists(Name))
